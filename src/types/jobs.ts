...
export const SAMPLE_JOBS: Job[] = [
  ...
  },
  {
    ...
    status: "interviewing",
    notes:
      "Recruiter reached out on LinkedIn. First round scheduled for next week.",
  ...
  },
  {
    ...
    status: "offered",
    notes:
      "Got the offer! Package is good. Deciding between this and Razorpay.",
  ...
  },
  {
    ...
    status: "interviewing",
    notes:
      "Two rounds done. Final round with the engineering manager tomorrow.",
